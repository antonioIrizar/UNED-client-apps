...
(function() {
  ...
  SolarElements = (function(_super) {
    __extends(SolarElements, _super);
    ...
    function SolarElements() {
      ...
      SolarElements.__super__.constructor.apply(this, arguments);
      this.lumens = null;
    ...
    SolarElements.prototype.bulb = function() {
      var a, bigElementBulb, bulb, button, div, divSlider, smallElementBulb, span, strong;
    ...
    SolarElements.prototype.solarPanel = function() {
      var a, button1, button2, div1, div2, divForm1, divForm2, divSlider1, divSlider2, p, smallElementSolar, solar, span, strong1, strong2, strong3;
    ...
    SolarElements.prototype.selectModalText = function(type) {
      switch (type) {
        case 'lumens':
