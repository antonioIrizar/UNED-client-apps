...
(function() {
  var Archimedes, Formula, Graph, Newton1, Variable,
  ...
  Archimedes = (function(_super) {
    ...
    Archimedes.prototype.newtownEquation = function(arrayVariables) {
  ...
  Newton1 = (function(_super) {
    ...
    function Newton1(divPanel, liFormula, constantValue, descriptionVariables) {
      var aceleration, force, graph, mass, panel, variables;
      ...
      Newton1.__super__.constructor.call(this, divPanel, liFormula, constantValue, descriptionVariables, 'images/archimedesFormula.png', variables, this.archimedesEquation, graph);
    }

    Newton1.prototype.archimedesEquation = function(arrayVariables) {
